...
export default function Pagination({
  ...
  const step =
    "ui-mono inline-flex h-10 items-center gap-2 rounded-full border px-4 transition-colors";
        ...
        <li className="mr-auto">
          {page > 1 ? (
            <Link
              ...
              className={clsx(
                step,
                "border-rule hover:border-oxblood hover:bg-oxblood hover:text-paper"
              )}
            >
            ...
            <span
              className={clsx(
                step,
                "border-transparent text-oxblood opacity-40"
              )}
            >
              <ArrowLongLeftIcon aria-hidden className="h-4 w-4" />
              <span className="hidden sm:inline">Previous</span>
        ...
        {items.map((item, index) =>
          item === "gap" ? (
            <li
              key={`gap-${index}`}
              aria-hidden
              className="ui-mono flex h-10 w-6 items-center justify-center text-oxblood"
            >
              &hellip;
            </li>
          ) : (
              ...
              <Link
                ...
                className={clsx(
                  ...
                  item === page
                    ...
                    : "text-oxblood hover:bg-wash hover:text-ink"
                )}
              >
                {item}
              </Link>
